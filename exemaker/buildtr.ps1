...
try {
    ...
    $scriptPath = Join-Path $PSScriptRoot 'troute.py'
    if (-not (Test-Path $scriptPath)) {
        Write-Error "Cannot find troute.py in $PSScriptRoot"
        exit 4
    }
